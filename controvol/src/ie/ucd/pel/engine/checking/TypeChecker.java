...
public class TypeChecker {
	...
	public Boolean isCompatiblePrimitiveTypes(String type1, String type2){
		...
		if (!res){
			res = typeObject2.equals(Cst.STRING_TYPE) || typeObject2.equals(Cst.OBJECT_TYPE);
			if (!res){
				res = !(typeObject1.equals(Cst.BOOLEAN_TYPE) || typeObject1.equals(Cst.STRING_TYPE) || typeObject2.equals(Cst.BOOLEAN_TYPE));
			}
		}
		return res;
	}
	...
	public Boolean isBiggerPrimitiveTypes(String type1, String type2){
		...
		Boolean cond2 = typeObject1.equals(Cst.STRING_TYPE) && typeObject2.equals(Cst.FLOAT_TYPE);
		Boolean cond3 = typeObject1.equals(Cst.STRING_TYPE) && typeObject2.equals(Cst.DOUBLE_TYPE);
	...
	public Boolean isParsedCorrectlyPrimitiveTypes(String type1, String type2){
		String typeObject1 = Util.removePackageName(Util.primitiveTypeToPrimitiveTypeObject(type1));
		String typeObject2 = Util.removePackageName(Util.primitiveTypeToPrimitiveTypeObject(type2));
		Boolean res = typeObject1.equals(typeObject2) || !typeObject2.equals(Cst.OBJECT_TYPE);
		return res;
	}
	...
	public Boolean isBiggerComplexTypes(String type1, String type2){
		...
		String typeObject2 = Util.removePackageName(Util.primitiveTypeToPrimitiveTypeObject(type2));
		Boolean cond1 = Util.isBiggerPrimitiveTypeObjects(typeObject1, typeObject2);
		Boolean cond2 = typeObject2.equals(Cst.STRING_TYPE);
		Boolean cond3 = typeObject1.equals(Cst.FLOAT_TYPE) || typeObject1.equals(Cst.DOUBLE_TYPE);
