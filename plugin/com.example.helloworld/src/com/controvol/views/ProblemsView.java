...
public class ProblemsView extends ViewPart {
	...
	public ProblemsView(){		
		...
		URL urlRepPlugin = bundle.getEntry(Cst.REP_PLUGIN);
		try {
	...
	private void createToolbar() {
		...
		ImageData compileIcon = new ImageData(Cst.PLUGIN_ID+"/icons/compile.png");

		compileIcon.scaledTo(16, 16);
		compileAction.setImageDescriptor(ImageDescriptor.createFromImageData(compileIcon));

		ImageData fixIcon = new ImageData(Cst.PLUGIN_ID+"/icons/fix.png");
